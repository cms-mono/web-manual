      ...
      { id: "global", group: "API 연동 · 부록", name: "국제 SMS",
        ...
        steps: [
          ...
          },
          {
            ...
            note: "국제 SMS는 <b>발신번호 등록이 불필요</b>합니다. 다만 발송 결과를 받으려면 <b>발신정보 &gt; 국제SMS 웹훅</b> 등록이 필요합니다(<b>시작하기 &gt; 발신정보</b> 탭 참고). 기존 고객사 점검 3종 — 청구계정 有 / <b>국제 SMS</b> 서비스 신청 有 / 국제SMS 웹훅 등록 有.",
          },
          {
            title: "도입 절차 ② — 연동 테스트 (국내 → 국내)",
            body: "국제 SMS 채널로 <b>한국 발신번호 → 한국 수신번호</b>로 발송해 보는 방식입니다. <b>해외 단말도, Sender ID 사전 등록도 필요 없어</b> 준비물 없이 즉시 가능하므로, 해외 발송 준비(단말 확보·국가 확정·Sender ID 심사)를 기다리는 동안 <b>연동 개발을 먼저 끝내 두기 위한 단계</b>입니다. 국제 SMS 단가표에 대한민국(KR)이 정식 등재되어 있어 규정상 유효한 발송입니다.",
            tables: [
              {
                label: "이 단계에서 검증되는 것",
                cols: ["항목", "내용"],
