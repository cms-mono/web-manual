      ...
      { id: "global", group: "API 연동 · 부록", name: "국제 SMS",
        ...
        steps: [
          ...
          },
          {
            ...
            list: [
              "① 커뮤니즈 가입 → 청구계정 등록 → <b>「국제 SMS」 서비스 신청</b>",
          ...
          },
          {
            ...
            table: {
              ...
              rows: [
                ...
                ["⑤", "연동 방식 결정", "<b>API 직접 연동</b> 또는 <b>Agent 연동</b>. 국제 SMS는 커뮤니즈 서비스라 <b>커뮤니즈를 연동하는 모노 에이전트</b>로도 보낼 수 있는데 <b>에이전트 제품에 따라 지원 여부가 다릅니다</b> — <b>M2X ONE</b>은 국제 SMS를 지원(<code>MSG_TYPE 21</code>), <b>Odyssey</b>는 메시지 구분에 국제 SMS가 없습니다. 어느 쪽이든 <b>KT ↔ 모노 협의</b>가 선행되어야 합니다"],
              ],
            },
          ...
          },
          {
            ...
            body: "국제 SMS 채널로 <b>한국 발신번호 → 한국 수신번호</b>로 발송해 보는 방식입니다. <b>해외 단말도, Sender ID 사전 등록도 필요 없어</b> 준비물 없이 즉시 가능하므로, 해외 발송 준비(단말 확보·국가 확정·Sender ID 심사)는 <b>빨라야 수 주</b>가 걸리므로, 그동안 <b>연동 개발을 먼저 끝내 두고</b> 준비가 끝나면 <b>수신번호만 바꿔 실발송</b>하기 위한 단계입니다. 국제 SMS 단가표에 대한민국(KR)이 정식 등재되어 있어 규정상 유효한 발송입니다.",
            tables: [
              {
                label: "이 단계에서 검증되는 것",
                cols: ["항목", "내용"],
          ...
          },
          {
            ...
            table: {
              ...
              rows: [
                ...
                ["모노 에이전트로 연동 가능한가요?", "<b>에이전트에 따라 다릅니다.</b> 국제 SMS는 커뮤니즈 서비스라 커뮤니즈를 연동하는 에이전트여야 하고, 그중 <b>M2X ONE은 지원</b>(<code>MSG_TYPE 21</code>), <b>Odyssey는 메시지 구분에 국제 SMS가 없습니다</b>. 어느 쪽이든 <b>KT ↔ 모노 협의</b>가 선행됩니다."],
