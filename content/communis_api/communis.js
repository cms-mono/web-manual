        ...
        steps: [
          ...
          },
          {
            ...
            list: [
              ...
              "<b>청구정보</b> — <b>선불 · 후불 · 월정액</b> 중 선택 (아래 단계 참고)",
            ...
            note: "⚠ 위 <b>메시징 API 목록은 청구정보를 ‘후불’(또는 선불)로 선택했을 때</b> 표시됩니다. <b>월정액</b>을 선택하면 <b>080 수신거부</b>가 대신 표시됩니다(아래 단계 참고).",
          },
          {
            title: "청구정보 선택 (선불 · 후불 · 월정액)",
            body: "서비스 신청 화면의 <b>청구정보</b>에서 과금 방식을 선택합니다. <b>선택한 청구 방식에 따라 신청 가능한 API 목록이 달라집니다.</b>",
            table: {
