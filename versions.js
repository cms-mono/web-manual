...
(function () {
  ...
  window.HUB_VERSIONS = {
    ...
    changelog: [
      { date: "2026-09-15", area: "KT RCS 웹 발송 — 기획팀 피드백 반영", items: [
        "따라하기 상단 안내 문구 정리 — 무엇을 누르면 되는지만 남기고 부연 삭제",
        "<b>가독성</b> — 본문·따라하기에서 읽는 글자를 1~1.5px 확대하고 보조 글자색을 한 단계 짙게(다크 테마는 밝게)",
        "외부에 나가면 안 되는 <b>KT RCS 고객센터 연락처</b>를 이용 프로세스 표에서 제거",
        "고객용 톤 정리 — 과한 경고 표현과 ‘언제 확인했는지’ 같은 확인 이력 문구 삭제",
      ] },
      { date: "2026-09-11", area: "KT RCS 웹 발송 — 선행 준비 · 발송 절차 정정", items: [
        "<b>이용 프로세스 5단계 → 7단계</b> — 한 줄에 뭉쳐 있던 RBC 선행 작업을 ① 브랜드 개설 / ② 대화방(발신번호) 등록 / ③ 대행사 운영권한 부여(케이티)로 분리하고, 각 행에서 RBC 가이드 해당 탭으로 바로 이동",
        "③이 빠지면 KT를 통한 발송이 되지 않는다는 점과 <b>브랜드 승인 후에만 대행사 지정 가능</b>, 권한 부여 후 <b>서버 동기화 약 3~4시간</b> 명시",
        "<b>메시지 저장 필수 정정</b> — 따라하기가 ‘저장은 선택’이라고 잘못 안내해 그대로 따라가면 발송에서 막혔음. 저장하면 수신자·발송그룹ID·표기의무 체크가 지워진다는 순서 안내도 추가",
        "고객 안내용으로 <b>RBC 사전 준비(브랜드·대화방·운영권한) 단일 HTML</b> 별도 제작",
      ] },
