...
const HZ_TYPES = {
  ...
  tmpl: {
    ...
    tip: { write: "템플릿은 문구가 정해져 있어 <b>제목·내용을 쓰지 않습니다.</b> 변수 카운터(90자)를 지켜도 <b>고정 문구 + 변수</b>가 본문 한도를 넘으면 <b>55709</b>로 실패합니다." },
    set: {
    ...
    detail: {
      ...
      body: [
        ...
        { t: "⚠ 변수 글자수 — 카운터가 초록이어도 실패할 수 있습니다", hi: ["변수 입력"],
          d: "변수마다 <b>90자</b> 카운터가 붙고 맨 아래에 <b>총합</b> 카운터가 있습니다. 화면 경고 그대로 — <i>변수 가변내용 총 글자 합이 90자 이상일 경우 메시지가 전송되지 않습니다.</i><br><b class=\"hz-warn\">그런데 이 카운터는 변수 값만 셉니다.</b> 실제로 걸리는 한도는 <b>템플릿 고정 문구 + 변수 값</b>을 합친 <b>본문 전체</b>이고, 넘기면 <b>결과코드 55709(Description 최대 글자수 초과)</b>로 실패합니다.<br><b class=\"hz-warn\">고정 문구가 긴 템플릿은 변수를 비워도 발송되지 않습니다.</b> 실제로 고정 문구가 <b>84자</b>인 템플릿은 변수를 1글자씩만 넣어도 55709로 막혔습니다(2026-09-08 실측). 승인이 끝난 템플릿이어도 그렇습니다.<br><b class=\"hz-ex\">이 화면의</b> <code>모노_인증메시지</code>는 고정 문구가 <b>25자 남짓</b>이라 여유가 넉넉합니다. <b>고정 문구가 짧은 템플릿을 고르는 것</b>이 가장 확실합니다." },
