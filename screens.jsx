    ...
    detail: {
      ...
      body: [
        { t: "제목·내용 입력란이 없습니다", hi: ["템플릿 설정 정보"],
          d: "템플릿은 <b>문구가 이미 정해져 있어</b> 직접 쓰는 칸이 없습니다. 대신 <b>템플릿 설정 정보</b> 영역이 생기고, 여기서 <b>버튼 확인</b>과 <b>변수 입력</b>만 합니다." },
        ...
        { t: "미리보기에는 변수가 치환되지 않습니다", hi: ["모노 문의 접수 안내"],
          d: "값을 넣어도 오른쪽 미리보기는 <code>{{name}}</code> 처럼 <b>변수 표기 그대로</b> 보여줍니다. 실제 치환은 발송할 때 일어나므로, 치환 결과는 <b>테스트 발송으로 확인</b>해야 합니다. 미리보기 종류도 <b>openrichcard</b>로 표시됩니다." },
      ],
