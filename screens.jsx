...
const HZ_SRC = [
  ...
  { part: "msgtype",  title: "메시지 종류 선택",
    ...
    detail: [
      { t: "① 메시지 종류 — [조회]를 누릅니다", hi: ["메시지 종류"],
        d: "메시지 종류를 먼저 골라야 아래 제목·내용 입력란이 열립니다. 칸 오른쪽의 <b>[조회]</b>를 누릅니다." },
  ...
  { part: "common",   title: "공통 정보 · 제목 · 내용",
    ...
    detail: [
      ...
      { t: "제목 · 내용 → 미리보기", hi: ["메시지 제목", "기존 RCS · SMS"],
        d: "제목과 내용을 쓰면 오른쪽 미리보기에 바로 반영됩니다. 종류를 고르기 전에는 <i>메시지 종류를 선택 해주세요.</i> 만 떠 있습니다.<br><b class=\"hz-ex\">이 화면에서는</b> 내용에 <code>{{변수1}}님, 요청하신 안내 자료를 보내드립니다.</code> 를 넣었습니다." },
