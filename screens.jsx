    ...
    detail: {
      ...
      body: [
        ...
        { t: "변수 이름은 템플릿이 정합니다", hi: ["변수 입력"],
          d: "직접 작성할 때의 <b>변수1~변수6</b>과 달리, 템플릿은 <b>만들 때 붙인 이름</b>이 그대로 나옵니다. 이 템플릿은 <code>name</code> · <code>cell2</code> · <code>cell4</code> 세 개입니다. 칸에 값을 넣으면 발송 시 그 자리에 치환됩니다." },
        { t: "⚠ 변수 글자수 — 카운터가 초록이어도 실패할 수 있습니다", hi: ["변수 입력"],
          d: "변수마다 <b>90자</b> 카운터가 붙고 맨 아래에 <b>총합</b> 카운터가 있습니다. 화면 경고 그대로 — <i>변수 가변내용 총 글자 합이 90자 이상일 경우 메시지가 전송되지 않습니다.</i><br><b class=\"hz-warn\">그런데 이 카운터는 변수 값만 셉니다.</b> 실제 한도는 <b>템플릿 고정 문구 + 변수 값</b>을 합친 <b>본문(description) 전체</b>이고, 여기를 넘기면 <b>결과코드 55709(Description 최대 글자수 초과)</b>로 실패합니다.<br><b class=\"hz-ex\">이 화면에서는</b> 고정 문구가 <b>84자</b>여서 변수에 쓸 수 있는 여유가 <b>16자 남짓</b>뿐입니다. <code>21 / 90</code> 이라 여유로워 보여도 전체로는 <b>105자</b>가 되어 발송이 막힙니다.<br>변수를 짧게 잡아 전체를 <b>100자 안</b>으로 맞추거나, 문구가 짧은 템플릿을 써야 합니다." },
