...
const HZ_SRC = [
  ...
  { part: "name",     title: "메시지 저장 · 표기 의무 확인",
    ...
    tip: "메시지 이름을 입력하고 <b>[메시지 저장]</b>까지 눌러야 발송할 수 있습니다.",
    detail: [
      ...
      { t: "저장은 꼭 하고 넘어갑니다", hi: ["메시지 이름"],
        d: "저장하지 않으면 발송할 수 없습니다. 저장 없이 <b>[발송]</b>을 누르면 <i>메시지를 저장해야 발송이 가능합니다</i> 안내가 뜹니다." },
      { t: "저장을 먼저, 수신자는 그 다음에", hi: ["메시지 이름"],
        d: "<b>[메시지 저장]</b>을 누르면 <b>수신자 목록 · 발송그룹ID · 표기 의무 체크</b>가 지워집니다. 저장을 마친 뒤에 발송 정보와 수신자를 채우세요. 이 따라하기의 단계 순서(작성 \u2192 저장 \u2192 발송 정보 \u2192 수신자 \u2192 발송)가 그 순서입니다." },
...
const HZ_GROUPS = [
  ...
  { id: "write", title: "메시지 작성",            kind: "유형별", from: ["common", "fallback", "name"],
    ...
    tip: "<b>'(광고)' 표시 여부</b>와 <b>무료 수신거부번호</b>는 필수 항목(*)입니다. 메시지는 <b>저장까지 마쳐야</b> 발송할 수 있습니다.",
