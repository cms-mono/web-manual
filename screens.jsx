...
const HZ_STEPS = [
  { part: "brand",    title: "브랜드 · 발신번호 선택",
    ...
    detail: [
      ...
      { t: "② 브랜드 선택 팝업이 뜹니다", hi: ["브랜드 선택"], pop: "brand",
        d: "제목은 <b>‘브랜드를 선택해주세요’</b>. 표는 <b>번호 · 브랜드 명 · 브랜드 ID</b> 3열이고 위에 검색창이 있습니다. <b>내 계정에 등록·승인된 브랜드만</b> 나옵니다. 한 줄을 고르고 <b>[확인]</b>.<br><b class=\"hz-ex\">이 화면에서는</b> <code>모노커뮤니케이션즈</code> 를 골랐습니다." },
      { t: "③ 브랜드 목록이 비어 있다면", hi: ["브랜드 선택"], pop: "brandEmpty",
        d: "RBC(RCS 비즈니스센터) 쪽을 확인합니다.<br>· RBC 사이트에서 <b>브랜드를 등록</b>했는지, 그리고 <b>승인이 완료</b>되었는지<br>· <b>RBC 사이트 &gt; 브랜드 운영 관리</b>에서 <b>KT에 대행사 운영권한을 부여</b>했는지<br>둘 중 하나라도 빠져 있으면 이 목록에 나오지 않습니다." },
      ...
      { t: "⑤ 발신번호 선택 팝업이 뜹니다", hi: ["발신 번호"], pop: "number",
      ...
      { t: "⑥ 발신번호 목록이 비어 있다면", hi: ["발신 번호"], pop: "numberEmpty",
