  ...
  { part: "brand",    title: "브랜드 · 발신번호 선택",
    ...
    detail: [
      ...
      { t: "\u2467 대화방 유형 두 가지", hi: ["발신 번호"], pop: "number",
        d: "아래 목록에서 <b>3·5번은 번호 그대로</b>, <b>1·2·4번은 <code>bot-</code> 코드</b>인 것이 보입니다. <b>발신번호</b>로 등록하면 문자를 보내는 번호 그 자체가 대화방이 되어 <b>ID가 번호 그대로</b>입니다.<br><b>양방향 ID</b>로 등록하면 하나의 발신번호 아래 <b>여러 ID를 만들어</b> 대화방명과 대화방 메뉴를 다르게 노출할 수 있고, 번호 대신 발급된 코드가 ID가 되어 <code>bot-</code>으로 시작합니다.<br>같은 번호를 쓰면서 부서·브랜드별로 이름을 달리 보여주고 싶을 때 양방향 ID를 씁니다.",
