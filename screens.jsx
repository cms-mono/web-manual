...
const HZ_TYPES = {
  ...
  tmpl: {
    ...
    shot: "",
    tip: { write: "템플릿은 문구가 정해져 있어 <b>제목·내용을 쓰지 않습니다.</b> 변수 값의 <b>총합 90자</b>를 넘기면 발송되지 않습니다." },
    set: {
      msgtype: [["규격", "기존 RCS"], ["종류", "템플릿"], ["템플릿", "모노 문의 접수 안내"]],
      write: [["'(광고)' 표시", "미사용"], ["무료 수신거부번호", "비움(선택)"], ["만료 옵션", "40초"],
              ["변수 name", "홍길동"], ["변수 cell2", "통합메시징"], ["변수 cell4", "2026-0908-001"],
              ["변수 총합", "21 / 90"], ["Fallback", "미사용"]],
    ...
    detail: {
      ...
      body: [
        ...
        { t: "⚠ 변수 글자수 — 각 90자, 그리고 총합 90자", hi: ["변수 입력"],
          d: "변수마다 <b>90자</b> 카운터가 붙고, 맨 아래에 <b>총합</b> 카운터가 따로 있습니다. 화면 경고 그대로 — <i>변수 가변내용 총 글자 합이 90자 이상일 경우 메시지가 전송되지 않습니다.</i><br>변수 하나하나가 짧아도 <b>다 더해서 90자를 넘기면 발송되지 않으니</b> 수신자별 값이 긴 경우 특히 주의해야 합니다.<br><b class=\"hz-ex\">이 화면에서는</b> 3+5+13 = <code>21 / 90</code> 입니다." },
