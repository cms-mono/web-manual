  ...
  { part: "brand",    title: "브랜드 · 발신번호 선택",
    ...
    detail: [
      ...
      { t: "\u2461 목록이 비어 있다면 — 아직 등록·승인 전입니다", hi: ["브랜드 선택"], pop: "brandEmpty",
        d: "팝업은 떴는데 표가 비어 있다면 RBC(RCS 비즈니스센터) 쪽을 확인합니다.<br>· RBC 사이트에서 <b>브랜드를 등록</b>했는지, 그리고 <b>승인이 완료</b>되었는지<br>· <b>RBC 사이트 &gt; 브랜드 운영 관리</b>에서 <b>KT에 대행사 운영권한을 부여</b>했는지<br>둘 중 하나라도 빠져 있으면 이 목록에 나오지 않습니다." },
